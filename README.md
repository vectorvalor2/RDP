...
/*build an AI Scene Generator that links to project templates to generate 3D Scenes, Game Levels, Simulations, and Particle Systems from Assets -> Projects -> to viewport*/
