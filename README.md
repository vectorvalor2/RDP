...
/*build an AI Scene Generator to generate 3D Scenes, Game Levels, Simulations, and Particle Systems from Assets -> Projects -> Scenes to viewport from extracting reference images*/
